# Leanstral.Solana Support Library
...
See `Leanstral/Solana/Token.lean` for detailed documentation of trust assumptions.
...
```bash
# The leanstral tool automatically copies this library
./bin/leanstral analyze --input program.rs --output-dir /tmp/analysis
./bin/leanstral generate ... --output-dir /tmp/proofs
```
...
ln -s ../../../crates/leanstral/lean_support .
```
...
1. Add to the appropriate module in `Leanstral/Solana/`
2. Export in the `Leanstral.Solana` namespace
...
- `Leanstral.lean`: Root module that exports everything
- `Leanstral/Solana/Account.lean`: Account structure and field access
- `Leanstral/Solana/Token.lean`: Token operations and conservation axioms
- `Leanstral/Solana/State.lean`: Lifecycle and state machine types
