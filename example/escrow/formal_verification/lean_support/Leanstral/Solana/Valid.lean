...
namespace Leanstral.Solana.Valid
...
end Leanstral.Solana.Valid

namespace Leanstral.Solana

-- Export validity predicates
abbrev U8_MAX := Leanstral.Solana.Valid.U8_MAX
abbrev U16_MAX := Leanstral.Solana.Valid.U16_MAX
abbrev U32_MAX := Leanstral.Solana.Valid.U32_MAX
abbrev U64_MAX := Leanstral.Solana.Valid.U64_MAX
abbrev U128_MAX := Leanstral.Solana.Valid.U128_MAX

abbrev valid_u8 := Leanstral.Solana.Valid.valid_u8
abbrev valid_u16 := Leanstral.Solana.Valid.valid_u16
abbrev valid_u32 := Leanstral.Solana.Valid.valid_u32
abbrev valid_u64 := Leanstral.Solana.Valid.valid_u64
abbrev valid_u128 := Leanstral.Solana.Valid.valid_u128

abbrev valid_u64_preserved_by_zero := Leanstral.Solana.Valid.valid_u64_preserved_by_zero
abbrev valid_u64_preserved_by_same := Leanstral.Solana.Valid.valid_u64_preserved_by_same
